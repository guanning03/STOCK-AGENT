...
mkdir -p /home/azanette/code/STOCK-AGENT/scripts/03_topk/logs
...
TOP_K_SHORTLIST_K="${TOP_K_SHORTLIST_K:-5}"
...
log="/home/azanette/code/STOCK-AGENT/scripts/03_topk/logs/${safe_model}_topk${TOP_K_SHORTLIST_K}_${DECISION_SPACE_MODE}_${ts}.log"

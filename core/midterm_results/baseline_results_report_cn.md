...
![Baseline NAV 曲线](./images/baseline_primary_nav.png)

![相对 Benchmark 的超额收益曲线](./images/baseline_primary_relative.png)

![Baseline 回撤曲线](./images/baseline_primary_drawdown.png)
...
![单笔交易金额分布](./images/baseline_primary_trade_values.png)
...
![交易次数与收益关系](./images/baseline_trade_count_vs_return.png)
...
![换手率与收益关系](./images/baseline_turnover_vs_return.png)
...
![GPT-4o-mini Baseline 与 Discrete Action Space 的 NAV 曲线](./images/gpt_discrete_action_space_nav.png)

![GPT-4o-mini Baseline 与 Top-5 Shortlist 的 NAV 曲线](./images/gpt_top5_shortlist_nav.png)
